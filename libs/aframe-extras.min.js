                              ...
                              for (
                                ...
                                if (1 === n.nodeType)
                                  switch (n.nodeName) {
                                    case "axis":
                                      var r =
                                        n.getElementsByTagName("param")[0];
        ...
        t.exports = AFRAME.registerComponent("gamepad-controls", {
          ...
          isVelocityActive: function () {
            ...
            var e = this._dpadVector,
              t = this._moveVector;
            this.getDpad(e), this.getJoystick(o.MOVEMENT, t);
            var i = e.x || t.x,
              n = e.y || t.y;
          ...
          getGamepad: function () {
            var e =
              ...
              t = this.system.controllers[this.data.controller],
              i = t && t.gamepad,
              n = this.el.sceneEl.components["proxy-controls"];
            return (
              (n && n.isConnected() && n.getGamepad(this.data.controller)) ||
              i ||
              e
            );
          },
